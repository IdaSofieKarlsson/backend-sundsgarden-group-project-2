...
const AllUsersPage = () => {
  ...
  const [profiles, setProfiles] = useState<Profile[]>([
    { firstName: 'Erik', lastName: 'Andersson', initials: 'EA', image: erikImg },
    { firstName: 'Maria', lastName: 'Lindström', initials: 'ML', image: mariaImg },
    { firstName: 'Anders', lastName: 'Nilsson', initials: 'AN', image: andersImg },
    { firstName: 'Sofia', lastName: 'Johansson', initials: 'SJ', image: sofiaImg },
    { firstName: 'Lars', lastName: 'Karlsson', initials: 'LK', image: larsImg },
    { firstName: 'Emma', lastName: 'Bergström', initials: 'EB', image: emmaImg },
    { firstName: 'Gustav', lastName: 'Lundqvist', initials: 'GL', image: gustavImg },
    { firstName: 'Anna', lastName: 'Pettersson', initials: 'AP', image: annaImg },
  ]);
